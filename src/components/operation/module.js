...
import {
    ...
    Trans_ModelTest_Input_Label, Trans_OptParam, Trans_OptResult, onCloseAlert,
    WIDTH_OUTPUT_LONG,
} from "./func";
import {DEFAULT_SIDES} from "../func";
...
export const OptTitle = ({model_name, opt, optStyle, onClick, getComp, getLoss}) => {
    ...
    const replaceOptUrl = () => {
        ...
        } else if (DEFAULT_SIDES.includes(optStyle)) {        // OptResult, OptRecord
    ...
    return (
        <div className="Opt-Title" style={{paddingRight: `${size + offset}px`}}>
            <h1 style={{textAlign: 'center', flex: 1}}>
                ...
                {DEFAULT_SIDES.includes(optStyle)
